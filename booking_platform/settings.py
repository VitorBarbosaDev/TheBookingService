...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
              ...
              #  'bag.contexts.bag_contents', # Will be added later if required for the project
            ],
            'builtins': [
...
STRIPE_WH_SECRET = os.getenv('STRIPE_WH_SECRET', '')# Webhook secret Can't get this yet


if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'TheBookingService@example.com'
else:
